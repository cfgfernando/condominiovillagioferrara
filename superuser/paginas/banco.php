<?
	...
	$conecta = db_connect($host, $usuario, $senha) or
			   die('N&atilde;o foi poss&iacute;vel conectar com o banco de dados! Verifique se os dados de conex&atilde;o estão corretos em <b>superuser/paginas/config.php </b>');
	db_select_db($banco); 
