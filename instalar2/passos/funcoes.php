...
function CompletaLinkGoogle($link){
	...
	// Atualiza a página pai do PopUp
	...
	// Função para limpar o http do link
	function LimpaLink($url_link){
		if( substr( $url_link, 0 ,7 ) == "http://" ){
			$tamanho = strlen($url_link); ##CUIDADO## Necessita da funçãoStringLenght
...
<?		
	...
	class IMG {
		...
		function scriptsphp($facebook, $twitter, $linkedin, $f, $s){
			if ($f=="2"){
		echo '<div id="footer">';
		echo '<div id="social_icons"  class="footer">';
		echo '<div>&nbsp;<br /><br />&nbsp;';
		if($facebook != ""){ echo "<a href='http://facebook.com/".$facebook."'><img src='img/icon_fb.png'></a>&nbsp;&nbsp;";}
		if($twitter != ""){ echo "<a href='http://twitter.com/".$twitter."'><img src='img/icon_twitter.png'></a>&nbsp;&nbsp;";}
		if($linkedin != ""){ echo "<a href='http://linkedin.com/".$linkedin."'><img src='img/icon_in.png'></a>";}
  
		echo '</div>';
		echo '<a href="http://www.rolly.com.br" id="footertext" name="footerautor">Rolly Santos</a> Photografia e Filmagens &copy; <a href="http://facebook.com/rolly.com.br">Contato</a>';
  
		echo '<script src="superuser/assets/js/jquery-1.10.2.js"></script> 
		<script src="superuser/assets/js/bootstrap.min.js"></script> 
		<script src="superuser/assets/js/jquery.metisMenu.js"></script> 
