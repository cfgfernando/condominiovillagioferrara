...
.temcor {
  ...
  <div class="corpoboleto"> 
    ...
    <div class="tamanho"  align="left">
      ...
      <div class="barravertical float"> &nbsp; </div>
      <div class="caixatexto float">
        <div class="titulo" style="min-width:160px;">Nosso n&uacute;mero</div>
    ...
    <div class="tamanho"  align="left">
      ...
      <div class="barravertical float"> &nbsp; </div>
      <div class="caixatexto float temcor">
    ...
    <div class="tamanho" align="left">
      ...
      <div class="barravertical float">&nbsp;</div>
      <div class="caixatexto float temcor">
        <div class="titulo" style="min-width:200px;"> Vencimento </div>
    ...
    <div class="tamanho" align="left">
      ...
      <div class="barravertical float">&nbsp;</div>
      <div class="caixatexto float">
        <div class="titulo" style="min-width:200px;"> Ag&ecirc;ncia/C&oacute;digo cedente </div>
    ...
    <div class="tamanho" align="left">
      ...
      <div class="barravertical float">&nbsp;</div>
      <div class="caixatexto float">
        <div class="titulo" style="min-width:100px;"> Data processamento </div>
        <div class="campo"> <?php echo $dadosboleto[ "data_processamento"]?> </div>
      </div>
      <div class="barravertical float">&nbsp;</div>
      <div class="caixatexto float">
        <div class="titulo" style="min-width:200px;"> Nosso n&uacute;mero </div>
        <div class="campo" align="right"> <?php echo $dadosboleto[ "nosso_numero"]?> </div>
      </div>
      <div style="clear: left;"></div>
      <div class="barrahorizontal">&nbsp;</div>
    ...
    <div class="tamanho" align="left">
      ...
      <div class="barravertical float">&nbsp;</div>
      <div class="caixatexto float">
        <div class="titulo" style="min-width:100px;"> Valor Documento </div>
        <div class="campo" align="right"> <?php echo $dadosboleto[ "valor_unitario"]?> </div>
      </div>
      <div class="barravertical float">&nbsp;</div>
      <div class="caixatexto float">
        <div class="titulo" style="min-width:200px;"> (=) Valor documento </div>
        <div class="campo" align="right"> <?php echo $dadosboleto[ "valor_boleto"]?> </div>
      </div>
      <div style="clear: left;"></div>
      <div class="barrahorizontal">&nbsp;</div>
