...
<HTML>
	...
	<div class="boletoview" style="margin:0 auto; width: 700px;">
					...
					<DIV ALIGN="left">
						<p>
							<li>
								...
								ou alta (N&atilde;o use modo econ&ocirc;mico).
								<br>
								<li>
									Utilize folha A4 (210 x 297 mm) ou Carta (216 x 279 mm) e margens m&iacute;nimas
									&agrave; esquerda e &agrave; direita do formul&aacute;rio.
									<br>
									<li>
										Corte na linha indicada. N&atilde;o rasure, risque, fure ou dobre a regi&atilde;o
										onde se encontra o c&oacute;digo de barras.
										<br>
										<li>
											Caso n&atilde;o apare&ccedil;a o c&oacute;digo de barras no final, clique
											em F5 para atualizar esta tela.
											<li>
												Caso tenha problemas ao imprimir, copie a sequencia num&eacute;rica abaixo
												e pague no caixa eletr&ocirc;nico ou no internet banking:
												<br>
												<br>
												<span class="ld2">
													&nbsp;&nbsp;&nbsp;&nbsp;Linha Digit&aacute;vel: &nbsp;
			...
			<TBODY>
				<TR>
					<TD class=ct width=666>
						<img height=1 src=paginas/boleto/imagens/6.png width=665 border=0>
					</TD>
				</TR>
				<TR>
					<TD class=ct width=666>
		...
		<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
			<tr>
				<td width=41>
					<IMG SRC="paginas/boleto/imagens/logo_empresa.png">
				</td>
		...
		<table cellspacing=0 cellpadding=0 width=666 border=0>
			<tr>
				<td class=cp width=150>
					<span class="campo">
						<IMG src="paginas/boleto/imagens/logosantander.jpg" width="140" height="37"
						border=0>
					</span>
				</td>
				<td width=3 valign=bottom>
					<img height=22 src=paginas/boleto/imagens/3.png width=2 border=0>
				</td>
			...
			<tbody>
				<tr>
					<td colspan=5>
						<img height=2 src=paginas/boleto/imagens/2.png width=666 border=0>
					</td>
				</tr>
			</tbody>
		</table>
			...
			<tbody>
				<tr>
					<td class=ct valign=top width=7 height=13>
						<img height=13 src=paginas/boleto/imagens/1.png width=1 border=0>
					</td>
				...
				<tr>
					<td class=cp valign=top width=7 height=12>
						<img height=12 src=paginas/boleto/imagens/1.png width=1 border=0>
					</td>
					...
					<td class=cp valign=top width=126 height=12>
						<span class="campo">
							<?php $tmp2=$ dadosboleto[ "codigo_cliente"]; $tmp2=s ubstr($tmp2,0,strlen($tmp2)-1).
							'-'.substr($tmp2,strlen($tmp2)-1,1); ?>
								<?php echo $dadosboleto[ "ponto_venda"].
								" <img src='paginas/boleto/imagens/b.png' width=10 height=1> ".$tmp2?>
						</span>
					</td>
					<td class=cp valign=top width=7 height=12>
						<img height=12 src=paginas/boleto/imagens/1.png width=1 border=0>
					...
					<td class=cp valign=top align=right width=120 height=12>
						<span class="campo">
							<?php $tmp=$ dadosboleto[ "nosso_numero"]; $tmp=s ubstr($tmp,0,strlen($tmp)-1).
							'-'.substr($tmp,strlen($tmp)-1,1); print $tmp; ?>
						</span>
					</td>
				</tr>
				<tr>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					<td valign=top width=298 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=298 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					<td valign=top width=126 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=126 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					<td valign=top width=34 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=34 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					<td valign=top width=53 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=53 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					<td valign=top width=120 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=120 border=0>
					</td>
				</tr>
			</tbody>
		</table>
			...
			<tbody>
				...
				<tr>
					...
					<td valign=top width=113 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=113 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					<td valign=top width=72 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=72 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					<td valign=top width=132 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=132 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					<td valign=top width=134 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=134 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					<td valign=top width=180 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=180 border=0>
					</td>
				</tr>
			</tbody>
		</table>
			...
			<tbody>
				...
				<tr>
					...
					<td valign=top width=112 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=112 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
			...
			<tbody>
				...
				<tr>
					...
					<td valign=top width=659 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=659 border=0>
					</td>
				</tr>
			</tbody>
		</table>
			...
			<tbody>
				...
				<tr>
					...
					<td class=cp valign=top width=472 height=12>
						<?php echo $dadosboleto[ "local_pagamento"]?>
					</td>
					<td class=cp valign=top width=7 height=12>
						<img height=12 src=paginas/boleto/imagens/1.png width=1 border=0>
					</td>
				...
				<tr>
					...
					<td valign=top width=472 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=472 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
			...
			<tbody>
				...
				<tr>
					...
					<td valign=top width=153 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=153 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					<td valign=top width=62 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=62 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					...
					<td valign=top width=82 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=82 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
		...
		<table cellspacing=0 cellpadding=0 border=0>
			<tbody>
				...
				<tr>
					...
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=75 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					<td valign=top width=31 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=31 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					<td valign=top width=83 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=83 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					...
					<td valign=top width=123 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=123 border=0>
					</td>
					<td valign=top width=7 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=7 border=0>
					</td>
					...
					<td align=right width=10>
						<table cellspacing=0 cellpadding=0 border=0 align=left>
							<tbody>
								...
								<tr>
									<td valign=top width=7 height=1>
										<img height=1 src=paginas/boleto/imagens/2.png width=1 border=0>
									</td>
								</tr>
							</tbody>
						</table>
			...
			<tbody>
				<tr>
					<td valign=top width=666 height=1>
						<img height=1 src=paginas/boleto/imagens/2.png width=666 border=0>
					</td>
				</tr>
			</tbody>
		</table>
