...
.direito .var {
  ...
  <div class="boletoview" style="margin:0 auto; width: 700px;">
    ...
    <div>
  <div rowspan="2" valign="bottom" style="width:150px; float:left;"><img src="paginas/boleto/imagens/logobradesco.jpg" alt="Banco Real" width="150" height="40" title="Banco" /></div>
  <div rowspan="2" align="right" valign="bottom" style="font-size: 15px; font-weight:bold; width:95%; alignment-adjust:middle">
  ...
  <? LimpaFloat(); ?>
      ...
      <table style="width:666px; border-bottom:solid; border-bottom-color:#000000; border-bottom-width:2px; border-top:solid; border-top-color:#000000; border-top-width:2px; margin-bottom: 5px;" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td class="td_7_cb"></td>
          <td><div class="titulo">Esp&acute;cie Doc.</div>
    ...
    <div align=right style="padding-right:40px;"> <br>
    ...
    <div id="boleto imprime">
      <table border="0" cellpadding="0" cellspacing="0" id="tb_logo">
        <tr>
          <td rowspan="2" valign="bottom" style="width:150px;"><img src="paginas/boleto/imagens/logobradesco.jpg" alt="Banco Real" width="150" height="40" title="Banco" /></td>
      ...
      <table class="tabelas" style="width:666px; border-left:solid; border-left-width:2px; border-left-color:#000000;" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td class="td_7_cb"></td>
          <td class="direito"><div class="titulo">Nosso N&acute;mero</div>
            <div class="var"><?php echo $dadosboleto[ "nosso_numero"]?></div></td>
          <td class="td_2"></td>
        </tr>
      </table>
      ...
      <table style="width:666px; border-top:solid; border-top-width:2px; border-top-color:#000000" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="td_7_sb"></td>
          <td style="width: 417px; height:62px;"><?php fbarcode($dadosboleto[ "codigo_barras"]); ?></td>
          <td class="td_7_sb"></td>
  ...
  <div align=right style="padding-right:45px;"> <br>
    Corte na linha pontilhada<br>
