...
.direito .var {
  ...
  <div class="boletoview" style="margin:0 auto; width: 700px;">
    ...
    <div>
  <div rowspan="2" valign="bottom" style="width:150px; float:left;"><img src="paginas/boleto/imagens/<?=db_result($res_dtbnc,"imagem_dtbnc");?>" alt="Banco Real" width="150" height="40" title="Banco" /></div><div>&nbsp;</div>
        ...
        <tr>
          ...
          <td><div class="titulo">Sacador / Avalista</div>
            <div class="var">
              ...
              <?php echo isset($dadosboleto[ "cpf_cnpj"]) ? "<br>".$dadosboleto[ "cpf_cnpj"] : '' ?></div>
            </div></td>
          <td class="td_7_sb"></td>
