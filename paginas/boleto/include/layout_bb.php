...
#instr_header {
	background: url('paginas/boleto/imagens/logo_empresa.png') no-repeat top left;
	padding-left: 160px;
	height: 65px;
}
...
<div class="boletoview" style="margin:0 auto; width: 700px;">
	<div id="container">
		...
		<!-- id="instr_header" -->
		<div id="">
			<!-- Use no lugar do <div id=""> caso queira imprimir sem o logotipo e instru&ccedil;&otilde;es
  <div id="instructions">
 -->
			<div id="instr_content">
				<p>
					O pagamento deste boleto tamb&eacute;m poder&aacute; ser efetuado nos
		...
		<div id="boleto">
			...
			<table class="header" border=0 cellspacing="0" cellpadding="0">
				<tbody>
					<tr>
						<td width=150>
							<IMG SRC="paginas/boleto/imagens/logobb.jpg">
						</td>
						<td width=50>
					...
					<tr class="campos">
						...
						<td class="carteira">
							<?php echo $dadosboleto[ "carteira"]?>
								<?php echo isset($dadosboleto[ "variacao_carteira"]) ? $dadosboleto[
								"variacao_carteira"] : '&nbsp;' ?>
						</td>
						<td class="especie2">
							<?php echo $dadosboleto[ "especie"]?>
